        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2 mt-3" onClick={e => e.stopPropagation()}>
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-gray-300 hover:bg-red-500/20 hover:border-red-500/50 hover:text-red-400 transition-colors"
            >
              删除
            </button>
          </div>

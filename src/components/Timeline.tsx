  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        style={{
          marginTop: '-20px',
          background: canScrollLeft ? 'rgba(123, 104, 238, 0.2)' : 'rgba(255, 255, 255, 0.05)',
          border: canScrollLeft ? '1px solid rgba(123, 104, 238, 0.3)' : '1px solid rgba(255, 255, 255, 0.05)',
        }}
      >
      ...
      <button
        ...
        style={{
          marginTop: '-20px',
          background: canScrollRight ? 'rgba(123, 104, 238, 0.2)' : 'rgba(255, 255, 255, 0.05)',
          border: canScrollRight ? '1px solid rgba(123, 104, 238, 0.3)' : '1px solid rgba(255, 255, 255, 0.05)',
        }}
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
